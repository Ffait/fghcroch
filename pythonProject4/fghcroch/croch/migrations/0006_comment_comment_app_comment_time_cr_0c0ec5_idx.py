# Generated by Django 4.1.3 on 2023-04-12 16:54
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='croch.comment', verbose_name='Родительский комментарий')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='croch.products', verbose_name='Продукт')),
            ],
            options={
